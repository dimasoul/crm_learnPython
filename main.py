...
from exams.subject import Subject, current_subject
import random
...
teacher1.teaches_subject(faker.word(ext_word_list=current_subject))
teacher2.teaches_subject(faker.word(ext_word_list=current_subject))

student1.get_grade(faker.word(ext_word_list=current_subject), 5)
student1.get_grade(faker.word(ext_word_list=current_subject), 5)
student2.get_grade(faker.word(ext_word_list=current_subject), 4)

teacher1.teaching_student(student1, faker.word(ext_word_list=current_subject))
teacher2.teaching_student(student2, faker.word(ext_word_list=current_subject))

student1.show_marks()
student2.show_marks()

student1.enrollment(faker.name())
...
exam1 = Exam(faker.word(ext_word_list=current_subject), sg1, faker.date(), faker.date())
exam2 = Exam(faker.word(ext_word_list=current_subject), sg2, faker.date(), faker.date())
